...
define([
   ...
   * class selector.
   */
  function FacetOptionsList(element, options) {
  ...
  FacetOptionsList.prototype = {

    events: FacetOptionsList.events,
  ...
  $.fn.facet_options_list = function (option) {
    ...
    return $elements.map(function (idx, element) {
      ...
      if (!object) {
        object = new FacetOptionsList($element, options);
