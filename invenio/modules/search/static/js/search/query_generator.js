...
define([], function() {
  ...
  /**
   * Concatenates query words by a logical operator.
  ...
  QueryGenerator.generateQuery = function(queryData, add_parentheses_if_necessary) {
    ...
    if (((box_queries.length === 1 && words_counter > 1) ||
        box_queries.length > 1) && add_parentheses_if_necessary) {
